...
public class Test1 {
    ...
    public void test() {
        ...
        even.battle(Apiary.getHiveList().get(0).getBees().get(0),
                Apiary.getHiveList().get(1).getBees().get(0));
        ...
        even.battle(Apiary.getHiveList().get(2).getBees().get(0),
                Apiary.getHiveList().get(3).getBees().get(0));
        ...
        dupe.battle(Apiary.getHiveList().get(0).getBees().get(10),
                Apiary.getHiveList().get(0).getBees().get(11));
        ...
        uneven.battle(Apiary.getHiveList().get(2).getBees().get(10),
                Apiary.getHiveList().get(1).getBees().get(40));
        ...
        uneven.battle(Apiary.getHiveList().get(3).getBees().get(1),
                Apiary.getHiveList().get(1).getBees().get(10));
